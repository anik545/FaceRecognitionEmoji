...
public class PictureCapturingServiceImpl extends APictureCapturingService {
     ...
     */
    private PictureCapturingServiceImpl(final Service service) {
        super(service);
    }
     ...
     */
    public static APictureCapturingService getInstance(final Service service) {
        return new PictureCapturingServiceImpl(service);
    }
